...
<body class="color-primary">
  ...
  <table class="table table-hover table-striped color-secondary text-light">
    <thead>
      <tr>
        <th></th>
        <th>GAME</th>
    ...
    <tbody>
      ...
      <?php else : ?>
        ...
        <?php foreach ($games as $game) : ?>
          <tr>
            <td width="200px">
              <image width="200px" src="../assets/<?= $game['image'] ?>"></a>
            </td>
            <td class="text-light" width="100px"><?= $game['name']; ?></a></td>
            <td class="text-light" width="100px"><?= $game['date']; ?></td>
            <td class="text-light" width="100px"><?= $game['review']; ?></td>
            <td class="text-light" width="300px"><?= $game['about']; ?></td>
            <td class="text-light" width="100px">Rp <?= $game['price']; ?></td>
            <td class="text-light" class="col">
              <a href="update.php?id=<?= $game['id'] ?>"><button type="button" class="btn btn-success mb-3">UPDATE</button></a>
  ...
  <footer class="color-secondary text-primary">
    <div class="container">
      <div class="row pt-3">
