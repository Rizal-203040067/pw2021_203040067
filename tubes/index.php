...
<body class="color-primary">
  ...
  <div class="container pt-5">
    <div class="row align-items-start">
      <table class="table mx-auto col color-secondary text-primary">
        <thead>
          <tr>
            <th></th>
            <th>GAME</th>
        ...
        <tbody class="text-light">
          ...
          <?php else : ?>
            ...
            <?php foreach ($games as $game) : ?>
              <tr>
                <td width="200px"><a href="php/detail.php?id=<?= $game["id"]; ?>">
                ...
                <td width="100px" class="text-center"><img src="./assets/review.svg" data-bs-toggle="tooltip" data-bs-placement="top" title="<?= $game["review"]; ?>"> </td>
